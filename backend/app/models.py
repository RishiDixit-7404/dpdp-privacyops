...
class ReadinessScan(Base):
    ...
    package_name: Mapped[str] = mapped_column(String(255), nullable=False, default="DPDP Technical Readiness Scan")
    price_inr: Mapped[int] = mapped_column(Integer, nullable=False, default=9999)
